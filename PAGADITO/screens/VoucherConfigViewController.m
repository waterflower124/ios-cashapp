...
@synthesize textScrollView, TransV, SidePanel, sessionInfoLabel, logoImageView, mensajeVoucherTextField;
...
- (IBAction)saveButtonAction:(id)sender {
    ...
    if(self.mensajeVoucherText.length == 0) {
        if(globals.selected_language == 0) {
            [self displayAlertView:@"¡Advertencia!" :@"Ingresa un mensaje personalizado que aparecerá en tu comprobante de venta. Ejemplo: ¡Gracias por su compra!"];
        } else {
            [self displayAlertView:@"Warning!" :@"Please enter a personalized message to appear on your proof of sale receipt. Example: Thank you for your purchase!"];
        }
        return;
    }
